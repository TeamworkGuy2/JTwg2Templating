...
public class PrimitiveTypeTemplate implements PrimitiveTypeInfo {
	...
	public static final PrimitiveTypeTemplate ofBoolean() {
		return new PrimitiveTypeTemplate(Boolean.TYPE);
	}


	public static final PrimitiveTypeTemplate ofByte() {
		return new PrimitiveTypeTemplate(Byte.TYPE);
	}


	public static final PrimitiveTypeTemplate ofChar() {
		return new PrimitiveTypeTemplate(Character.TYPE);
	}


	public static final PrimitiveTypeTemplate ofShort() {
		return new PrimitiveTypeTemplate(Short.TYPE);
	}


	public static final PrimitiveTypeTemplate ofInt() {
		return new PrimitiveTypeTemplate(Integer.TYPE);
	}


	public static final PrimitiveTypeTemplate ofFloat() {
		return new PrimitiveTypeTemplate(Float.TYPE);
	}


	public static final PrimitiveTypeTemplate ofLong() {
		return new PrimitiveTypeTemplate(Long.TYPE);
	}


	public static final PrimitiveTypeTemplate ofDouble() {
		return new PrimitiveTypeTemplate(Double.TYPE);
	}
